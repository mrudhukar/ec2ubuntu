...
h2. For EBS following additional steps are required
...
h3. These are common for both instance store and ebs*
...
<i>For EBS you should not pass bucket, prefix but pass --ebs</i>
